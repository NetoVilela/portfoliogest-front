...
import EcommerceRadial from 'sections/widget/chart/CardRadial';
    ...
    <Grid container rowSpacing={4.5} columnSpacing={3}>
      ...
      <Grid item xs={12} md={8} lg={9}>
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6}>
            <Stack spacing={3}>
              <EcommerceRadial title="teste" color={theme.palette.primary.main} valueTotal={10} valueArchived={0} valueOpen={10} />
              <EcommerceRadial title="teste" color={theme.palette.error.dark} valueTotal={10} valueArchived={0} valueOpen={10} />
            </Stack>
          </Grid>
        </Grid>
      </Grid>
