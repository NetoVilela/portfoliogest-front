					...
					<div>
						...
						<ul className="mb-6 flex flex-col gap-1.5">
							...
							<SidebarLinkGroup activeCondition={pathname === '/users' || pathname.includes('users')}>
								{(handleClick, open) => {
									return (
										<Group title="Usuários" open={open} mainRoute="users" pathname={pathname} handleClick={handleClick} sidebarExpanded={sidebarExpanded} setSidebarExpanded={setSidebarExpanded}>
											<ItemGroup title="Cadastrar" pathname={pathname} route="/users/form" />
											<ItemGroup title="Listar" pathname={pathname} route="/users/list" />
										</Group>
									);
								}}
							</SidebarLinkGroup>
