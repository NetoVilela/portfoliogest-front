...
export function filterProducts(filter: ProductsFilter) {
  return async () => {
    try {
      const response = await api.post('/api/products/filter', { filter });
...
export function getProduct(id: string | undefined) {
  return async () => {
    try {
      const response = await api.post('/api/product/details', { id });
...
export function getRelatedProducts(id: string | undefined) {
  return async () => {
    try {
      const response = await api.post('/api/product/related', { id });
...
export function getProductReviews() {
  return async () => {
    try {
      const response = await api.get('/api/review/list');
...
export function addAddress(address: Address) {
  return async () => {
    try {
      const response = await api.post('/api/address/new', address);
...
export function editAddress(address: Address) {
  return async () => {
    try {
      const response = await api.post('/api/address/edit', address);
