...
export function getColumnsOrder() {
  return async () => {
    try {
      const response = await api.get('/api/kanban/columns-order');
...
export function getComments() {
  return async () => {
    try {
      const response = await api.get('/api/kanban/comments');
...
export function getProfiles() {
  return async () => {
    try {
      const response = await api.get('/api/kanban/profiles');
...
export function getItems() {
  return async () => {
    try {
      const response = await api.get('/api/kanban/items');
...
export function getUserStory() {
  return async () => {
    try {
      const response = await api.get('/api/kanban/userstory');
...
export function getUserStoryOrder() {
  return async () => {
    try {
      const response = await api.get('/api/kanban/userstory-order');
...
export function addColumn(column: KanbanColumn, columns: KanbanColumn[], columnsOrder: string[]) {
  return async () => {
    try {
      const response = await api.post('/api/kanban/add-column', { column, columns, columnsOrder });
...
export function editColumn(column: KanbanColumn, columns: KanbanColumn[]) {
  return async () => {
    try {
      const response = await api.post('/api/kanban/edit-column', { column, columns });
...
export function updateColumnOrder(columnsOrder: string[]) {
  return async () => {
    try {
      const response = await api.post('/api/kanban/update-column-order', { columnsOrder });
...
export function deleteColumn(columnId: string, columnsOrder: string[], columns: KanbanColumn[]) {
  return async () => {
    try {
      const response = await api.post('/api/kanban/delete-column', { columnId, columnsOrder, columns });
...
export function addItem(
  ...
  return async () => {
    try {
      const response = await api.post('/api/kanban/add-item', { columnId, columns, item, items, storyId, userStory });
...
export function selectItem(selectedItem: string | false) {
  return async () => {
    try {
      const response = await api.post('/api/kanban/select-item', { selectedItem });
...
export function deleteItem(itemId: string | false, items: KanbanItem[], columns: KanbanColumn[], userStory: KanbanUserStory[]) {
  return async () => {
    try {
      const response = await api.post('/api/kanban/delete-item', { columns, itemId, userStory, items });
...
export function addStory(story: any, userStory: KanbanUserStory[], userStoryOrder: string[]) {
  return async () => {
    try {
      const response = await api.post('/api/kanban/add-story', { userStory, story, userStoryOrder });
...
export function editStory(story: KanbanUserStory, userStory: KanbanUserStory[]) {
  return async () => {
    try {
      const response = await api.post('/api/kanban/edit-story', { userStory, story });
...
export function updateStoryOrder(userStoryOrder: string[]) {
  return async () => {
    try {
      const response = await api.post('/api/kanban/update-story-order', { userStoryOrder });
...
export function addStoryComment(storyId: string, comment: KanbanComment, comments: KanbanComment[], userStory: KanbanUserStory[]) {
  return async () => {
    try {
      const response = await api.post('/api/kanban/add-story-comment', { userStory, storyId, comment, comments });
...
export function deleteStory(storyId: string, userStory: KanbanUserStory[], userStoryOrder: string[]) {
  return async () => {
    try {
      const response = await api.post('/api/kanban/delete-story', { userStory, storyId, userStoryOrder });
